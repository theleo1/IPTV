...
<section id="sign-up">
  <div class="title-signup">
    <p>Sign Up</p>
      <h1 class="sign-up">Create a new Account at Stream TV</h1>
  </div>
  ...
  <div class="Registration">
    <div class="containersign">
      <form>
        <img class="avatar" src="./images/log.jpg">        
        <br>
        <br>
...
<!--country-->
    ...
    <div class="links">Already have an Account? &nbsp; &nbsp;<a href="login.php">Log In</a>
    </div>
