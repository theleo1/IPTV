...
<section id="Sign-Up">
  <div class="title-SignUp">
    <p>Sign Up</p>
      ...
      <h1>Create a new Account at Stream TV</h1>
  ...
  <div class="input-group col-lg-6 mb-4">
          ...
          <div class="input-group col-lg-6 mb-4">
            ...
            <input id="Birthday" type="Birthday" name="Birthday" placeholder="Select your Birthday"
              class="form-control bg-white border-left-0 border-md" onfocus="(this.type='date')"
          ...
          <div class="input-group col-lg-6 mb-4">
            ...
            <select id="Country" type="Country" name="SelectCountry" placeholder="Select Your Country"
          ...
          <div class="input-group col-lg-6 mb-4">
            ...
            <select id="countryCode" name="countryCode" class="custom-select form-control bg-white border-left-0 border-md text-muted">
          ...
          <div class="col-lg-6 mb-4 wrapperCkBox">
            <input type="checkbox" id="RememberMe" name="RememberMe" value="true"><label for="RememberMe"> 
              Please accept the terms and conditions of our website</label>
            <input type="hidden" name="RememberMe" id="chkRememberMe" value="">
